...
const faqs = [
  ...
  { q: 'La consulenza iniziale è davvero gratuita?',
    a: 'Sì, senza alcun impegno. Il nostro team analizzerà la tua farmacia e ti presenterà un concept preliminare entro 7 giorni lavorativi. Solo se deciderai di procedere definiremo insieme il progetto completo.' },
