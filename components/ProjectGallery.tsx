...
const featured: Project = {
  ...
  imgSrc: 'https://picsum.photos/seed/210/800/1200',
  gradient: 'linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,181,181,0.32) 100%)',
};

const small: Project[] = [
  { name: 'Farmacia Bellini',      location: 'Catania', category: 'Ristrutturazione', imgSrc: 'https://picsum.photos/seed/215/600/600', gradient: 'linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.08) 60%, transparent 100%)' },
  { name: 'Farmacia San Leo',      location: 'Rimini',  category: 'Restyling',        imgSrc: 'https://picsum.photos/seed/220/600/600', gradient: 'linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.08) 60%, transparent 100%)' },
  { name: 'Farmacia Appio Latino', location: 'Roma',    category: 'Ampliamento',      imgSrc: 'https://picsum.photos/seed/225/600/600', gradient: 'linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.08) 60%, transparent 100%)' },
  { name: 'Farmacia Beneduce',     location: 'Napoli',  category: 'Trasferimento',    imgSrc: 'https://picsum.photos/seed/230/600/600', gradient: 'linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.08) 60%, transparent 100%)' },
];
